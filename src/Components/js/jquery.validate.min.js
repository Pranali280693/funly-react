...
(function( factory ) {
	...
	*/
	...
	$.validator.addMethod("check_date_of_birth", function (value, element,opt) {
		...
		maxDate.setYear(maxDate.getYear() - age);
		if (maxDate < mydate) {
			$.validator.messages.check_date_of_birth = "You must be at least " + age +" years of age";
			return false;
		}
		return true;
	});
